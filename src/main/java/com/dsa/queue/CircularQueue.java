...
public class CircularQueue {
    ...
    /**
     * public CircularQueue used to implement
     * @param size size of circular Queue
     */
    ...
    /**
     * enqueue method use to check queue is empty/full
     * @param value integer type parametrised value
     */
